    ...
    <aside style={{
      ...
      <div style={{ margin: '12px 10px 0', padding: '12px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: `1px solid ${C.navyBorder}`, display: 'flex', alignItems: 'center', gap: 9 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 12.5, fontWeight: 600, color: '#FFFFFF', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>PlantãoSeguro</div>
          <div style={{ fontSize: 10.5, color: 'rgba(255,255,255,0.45)', marginTop: 1 }}>Equipe Clínica</div>
        </div>
        <div style={{
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
      <div style={{
        ...
        <div>
          ...
          <h2 style={{ fontFamily: "'Inter',sans-serif", fontSize: 26, fontWeight: 800, marginBottom: 7, color:'#FFFFFF' }}>Bem-vindo(a) 👋</h2>
    ...
    try {
      const r = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          model: 'claude-sonnet-4-20250514',
          max_tokens: 2000,
          system: 'Você é especialista em enfermagem clínica de UTI. Gere evoluções de enfermagem profissionais, técnicas e objetivas.',
    ...
    try {
      ...
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          model: 'claude-sonnet-4-20250514',
          max_tokens: 2000,
          system: 'Você é especialista em enfermagem clínica de UTI com vasta experiência em documentação hospitalar. Gere anotações de enfermagem profissionais, objetivas, em linguagem técnica, em 3ª pessoa do singular, sem bullet points, texto corrido. Siga as normas do COFEN.',
